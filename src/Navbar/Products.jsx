...
useEffect(()=>{
  getProduct()
},[sorting,categorieFillter,brandFillter])
...
<div>
  <div className='flex justify-between mb-5'>
    <div><h1 className='font-bold text-2xl'>Products</h1></div>
    <div>
<button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" onClick={()=>setDropdown(!dropdown)}  class="cursor-pointer text-white relative bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Recommendation <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4 z-10" />
</svg>
</button>

{/* Dropdown menu */}
<div id="dropdown" class={`z-10  absolute ${dropdown ? "" : 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700`}>
    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
      ...
      <li onClick={()=>{setSorting(5)
        setDropdown(false)
      }}>
        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Discount : Low to High</a>
      </li>
      <li onClick={()=>{setSorting(6)
        setDropdown(false)
      }}>
        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Discount : High to Low</a>
      </li>
      <li onClick={()=>{setSorting(7)
        setDropdown(false)
      }}>
        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Rating : Low to Hogh</a>
      </li>
      <li onClick={()=>{setSorting(8)
        setDropdown(false)
      }}>
        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Rating : High to Low</a>
      </li>
    </ul>
</div>
</div>
